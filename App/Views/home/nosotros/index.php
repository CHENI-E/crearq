        ...
        <div class="row">
            <div class="col-12">
                <div class="text-center">
                    <h3 class="text-center font-weight-bold" style="color:#873299;">Somos una compañía con más de 20 años de experiencia y mucha pasión por la arquitectura.</h3>
...
<div class="container mt-5 mb-5">
    <div class="row py-3 m-auto text-center">
        ...
        <div class="col-lg-12 order-lg-2 order-1 py-2">
