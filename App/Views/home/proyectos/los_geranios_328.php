...
<section class="property-plans about-content pt-3 pb-5">
  <div class="container">
      ...
      <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.05s">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner">
            ...
            <div class="carousel-item">
              <img src="<?= $baseUrl ?>images/proyectos/espacios_proyectos/geranios03-1024x1024.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
    ...
    <section class="benefits p-0" style="margin-top:70px;">
      <div class="container">
        <div class="row">
          <a href="<?=$baseUrl?>pdf/BROCHURE-GERANIOS.pdf" target="_blank" class="col wow fadeInUp" data-wow-delay="0.05s">
          ...
          <a class="col wow fadeInUp" data-wow-delay="0.20s">
            ...
            <h6 style="font-size: 13px; color:#a6acaf; ">Calle Los Geranios 328 Lince</h6>
          </a>
        </div>
      </div> 
    </section>
    ...
    <div class="row mt-5 pt-5 mb-5">
      ...
      <div class="col-lg-6 order-lg-2">
        <div class="b2servicio_content">
          ...
          <form class="b2servicio_form" action="<?=$baseUrl?>Home/storeEmail" id="formServicio" method="post"
            ...
            <input type="hidden" name="i" value="geranios" required>
            <input type="hidden" name="project" value="LOS GERANIOS 328" required>
      ...
      <div class="col-lg-6 pt-5 order-lg-1">
        ...
        src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d3901.3159714538556!2d-77.026727!3d-12.090508!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105c863f125bc17%3A0x6a9e769bcdbf5521!2sC.%20Los%20Geranios%20328%2C%20Lince%2015046!5e0!3m2!1ses!2spe!4v1737353228519!5m2!1ses!2spe" 
