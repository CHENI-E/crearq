...
<!-- property-plans -->
<img src="<?= $baseUrl ?>images/portada3/parq (1).png" class="w-100" alt="">
...
<section class="property-plans about-content pt-3 pb-5">
  <div class="container">
      ...
      <div class="col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="0.05s">
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-item active" style="width: 100%; height:600px;">
              <img src="<?= $baseUrl ?>images/proyectos/espacios_proyectos/PARQ/EDIFICIO PARQ.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" style="width: 100%; height:600px;">
              <img src="<?= $baseUrl ?>images/proyectos/espacios_proyectos/PARQ/dormitorio (1).png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" style="width: 100%; height:600px;">
              <img src="<?= $baseUrl ?>images/proyectos/espacios_proyectos/PARQ/cocina (1).png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" style="width: 100%; height:600px;">
              <img src="<?= $baseUrl ?>images/proyectos/espacios_proyectos/PARQ/baño.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" style="width: 100%; height:600px;">
              <img src="<?= $baseUrl ?>images/proyectos/espacios_proyectos/PARQ/sala-vista-2.png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" style="width: 100%; height:600px;">
              <img src="<?= $baseUrl ?>images/proyectos/espacios_proyectos/PARQ/sala (1).png" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item" style="width: 100%; height:600px;">
              <img src="<?= $baseUrl ?>images/proyectos/espacios_proyectos/PARQ/dormitorio-secundario.png" class="d-block w-100" alt="...">
            </div>
          </div>
    ...
    <section class="benefits p-0" style="margin-top:70px;">
      <div class="container">
        <div class="row">
          <a href="<?=$baseUrl?>pdf/BROCHURE-PARQ.pdf" target="_blank" class="col wow fadeInUp" data-wow-delay="0.05s">
          ...
          <a href="<?=$baseUrl?>pdf/Dptos Parq (1).pdf" target="_blank" class="col wow fadeInUp" data-wow-delay="0.15s">
      ...
      <div class="col-lg-6 order-lg-2">
        <div class="b2servicio_content">
          ...
          <form class="b2servicio_form" action="<?=$baseUrl?>Home/storeEmail" id="formServicio" method="post"
            ...
            <input type="hidden" name="i" value="parq" required>
            <input type="hidden" name="project" value="AURORA 1940" required>
            ...
            <ul class="ul-config row d-flex justify-content-between">
              ...
              <li class="col-lg-12 px-1">
                <div class="input input_textarea"><label>Mensaje</label><textarea name="message" required maxlength="250" placeholder="Máximo 250 caracteres..."
