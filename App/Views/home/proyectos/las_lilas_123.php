  ...
  <div class="container">
    ...
    <div class="row align-items-center mt-5 mb-5">
      <div class="col-lg-6 col-md-6 wow fadeInUp">
        <img src="<?= $baseUrl ?>images/portada3/web-lilas-texto.png" width="100%" alt="">
    ...
    <section class="benefits p-0" style="margin-top:70px;">
      <div class="container">
        <div class="row">
          ...
          <a href="<?=$baseUrl?>pdf/Dptos Lilas.pdf" target="_blank" class="col wow fadeInUp" data-wow-delay="0.15s">
      ...
      <div class="col-lg-6 order-lg-2">
        <div class="b2servicio_content">
          ...
          <form class="b2servicio_form" action="<?=$baseUrl?>Home/storeEmail" id="formServicio" method="post" 
            ...
            <input type="hidden" name="i" value="lilas" required>
