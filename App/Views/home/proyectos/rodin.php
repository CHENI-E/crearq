...
<section class="property-plans about-content pt-3 pb-5">
  <div class="container">
      ...
      <div class="col-lg-6 col-md-6 wow fadeInUp">
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td style="width:20px !important;">•</td>
              <td>23 Departamentos</td>
            </tr>
            <tr>
              <td style="width:20px !important;">•</td>
              <td>1, 2 y 3 Dormitorios</td>
            </tr>
            <tr>
              <td style="width:20px !important;">•</td>
            ...
            <tr>
              <td style="width:20px !important;">•</td>
              <td>Tableros de piedra sinterizada</td>
            </tr>
            <tr>
              <td style="width:20px !important;">•</td>
              <td>Pisos SPC de alta resistencia al agua y gran durabilidad</td>
            </tr>
            <tr>
              <td style="width:20px !important;">•</td>
    ...
    <section class="benefits p-0" style="margin-top:70px;">
      <div class="container">
        <div class="row">
          <a href="<?=$baseUrl?>pdf/BROCHURE RODIN 245_virtual.pdf" target="_blank" class="col wow fadeInUp" data-wow-delay="0.05s">
          ...
          <a class="col wow fadeInUp" data-wow-delay="0.20s">
            ...
            <h6 style="font-size: 13px; color:#a6acaf; ">Rodin 245, <br> Surquillo 15038</h6>
          </a>
        </div>
      </div> 
    </section>
    ...
    <div class="row mt-5 pt-5 mb-5">
      ...
      <div class="col-lg-6 order-lg-2">
        <div class="b2servicio_content">
          ...
          <form class="b2servicio_form" action="<?=$baseUrl?>Home/storeEmail" id="formServicio" method="post" 
            ...
            <input type="hidden" name="i" value="rodin" required>
            <input type="hidden" name="project" value="LAS LILAS 123" required>
      ...
      <div class="col-lg-6 pt-5 order-lg-1">
        <iframe style="width:100%; height:100%;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3900.9597420612995!2d-76.9986649!3d-12.1149071!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9105c70057206a27%3A0x4df00b961a65354!2sRodin%20245%20-%20Crearq%20Inmobiliaria!5e0!3m2!1ses-419!2sco!4v1744409929187!5m2!1ses-419!2sco" 
