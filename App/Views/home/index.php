    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col wow fadeInUp" data-wow-delay="0s">
          <figure> <img src="<?= $baseUrl ?>images/icon-benefits01.png" alt="Image"> <b></b> </figure>
        ...
        <div class="col wow fadeInUp" data-wow-delay="0.10s">
          <figure> <img src="<?= $baseUrl ?>images/icon-benefits03.png" alt="Image"> <b></b> </figure>
          <h6>Spaces in Pozniaky</h6>
      ...
      <div class="row align-items-center">
        <div class="col-lg-6">
          <figure>
            ...
            <!-- end pattern-bg -->
            <div class="holder" data-stellar-ratio="1.07"> <img src="<?= $baseUrl ?>images/side-image02.jpg" alt="Image"></div>
            <!-- end holder -->
          </figure>
        </div>
        <!-- end col-6 -->
  ...
  <!-- property-plans -->
  <section class="get-consultation" data-background="<?= $baseUrl ?>images/section-bg01.jpg" data-stellar-background-ratio="0.9">
    <div class="container">
      <div class="row">
  ...
  <section class="property-customization">
    ...
    <div class="container">
      <div class="row">
        ...
        <!-- end col-2 -->
        <div class="col-lg-2 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.25s">
          <figure data-toggle="tooltip" data-placement="top" title="The smaller male cones release pollen, which fertilizes"> <img src="<?= $baseUrl ?>images/services-icon06.png" alt="Image">
        ...
        <!-- end col-2 -->
        <div class="col-lg-2 col-md-4 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.15s">
          <figure data-toggle="tooltip" data-placement="top" title="The smaller male cones release pollen, which fertilizes"> <img src="<?= $baseUrl ?>images/services-icon10.png" alt="Image">
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-lg-2 col-md-3 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.05s">
          <figure> <a href="<?= $baseUrl ?>images/certificate01.jpg" data-fancybox><img src="<?= $baseUrl ?>images/certificate01.jpg" alt="Image"></a> </figure>
        </div>
        <!-- end col-3 -->
        <div class="col-lg-2 col-md-3 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.10s">
          <figure> <a href="<?= $baseUrl ?>images/certificate02.jpg" data-fancybox><img src="<?= $baseUrl ?>images/certificate02.jpg" alt="Image"></a> </figure>
        </div>
        <!-- end col-3 -->
        <div class="col-lg-2 col-md-3 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.15s">
          <figure> <a href="<?= $baseUrl ?>images/certificate03.jpg" data-fancybox><img src="<?= $baseUrl ?>images/certificate03.jpg" alt="Image"></a> </figure>
        </div>
        <!-- end col-3 -->
        <div class="col-lg-2 col-md-3 col-sm-6 col-6 wow fadeInUp" data-wow-delay="0.20s">
          <figure> <a href="<?= $baseUrl ?>images/certificate04.jpg" data-fancybox><img src="<?= $baseUrl ?>images/certificate04.jpg" alt="Image"></a> </figure>
        </div>
        <!-- end col-3 -->
      </div>
      <!-- end row -->
