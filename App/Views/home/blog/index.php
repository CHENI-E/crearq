...
<header class="page-header" data-background="images/slide01.jpg" data-stellar-background-ratio="1.15">
    <div class="container">
      <h1>Blog</h1>
      <p>Nueva seccion para ver las ultimas noticias y promociones</p>
      <ol class="breadcrumb">
        ...
        <div class="col-lg-8">
          <div class="post">
            ...
            <div class="post-content">
              <h2 class="post-title"><a href="news-detail.html">The biggest updates from Construction annual developer
                  conference</a></h2>
              <div class="post-author">
                <img src="images/author01.jpg" alt="Image"><span>By</span><a href="#"> Steven Bradley</a>
              </div>
              <p class="post-intro">Webz hosted its annual construction’s conference yesterday and the main focus was to
                build a privacy platform more the eye is attracted.</p>
        ...
        <div class="col-lg-4">
          <aside class="sidebar">
            ...
            <div class="widget">
              ...
              <p>The smaller male cones release pollen, which fertilizes the female <u>amazing</u> and more
                <u>complex</u> to produce.</p>
            </div>
            <!-- end widget -->
            <div class="widget">
            ...
            <div class="widget">
              ...
              <ul class="side-gallery">
                ...
                <li><a href="images/gallery-thumb03.jpg" data-fancybox><img src="images/gallery-thumb03.jpg"
                      alt="Image"> </a></li>
                <li><a href="images/gallery-thumb04.jpg" data-fancybox><img src="images/gallery-thumb04.jpg"
                      alt="Image"> </a></li>
                <li><a href="images/gallery-thumb05.jpg" data-fancybox><img src="images/gallery-thumb05.jpg"
                      alt="Image"> </a></li>
                <li><a href="images/gallery-thumb06.jpg" data-fancybox><img src="images/gallery-thumb06.jpg"
                      alt="Image"> </a></li>
              </ul>
            </div>
            <!-- end widget -->
